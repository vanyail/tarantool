...
#define OP_Function0      83 /* synopsis: r[P3]=func(r[P2@P5])             */
#define OP_Function       84 /* synopsis: r[P3]=func(r[P2@P5])             */
...
#define OP_FCopy         110 /* synopsis: reg[P2@cur_frame]= reg[P1@root_frame(OPFLAG_SAME_FRAME)] */
...
#define OP_IdxDelete     121 /* synopsis: key=r[P2@P3]                     */
